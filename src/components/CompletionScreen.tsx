...
const PRAISE_PARAGRAPHS = [
  'Kjære Nina og Stig —',
  'Dere klarte det. Dere KLARTE DET! Badet er ferdig. Prosjektet er i mål. Og jeg, Pisken, tar av meg hatten.',
  'Ikke bare et nytt bad — dette er et bevis. Et bevis på at Nina Hårstad kan gjøre hva som helst hun setter seg fore. Et bevis på at Stig Hårstad har de rette kontaktene og det rette hodet til å få ting gjort. Et bevis på at et godt lag er fullstendig uslåelig.',
  'Og dere klarte det INNEN 12. JULI! Tenk over det. Samme helg som Nina feirer seksti strålende år. Seksti år med kreativitet, handlekraft, mot og stil. Hva er vel den perfekte gaven til seg selv på 60-årsdagen? Et nytt, skinnende, nydelig bad — skapt med egne hender, kloke valg og de rette telefonsamtalene.',
  'Og Piskens svigerforeldre ankommer akkurat denne helgen. Hva møter de når de kommer inn døren? Et bad som er ferdig. Et par som leverte. Et hjem som stråler. Det kaller jeg timing av ypperste klasse.',
  'Nina — du har alltid hatt det kreative øyet. Evnen til å se hva et rom kan bli. Men dette prosjektet viste noe enda mer: du er ikke bare kreativ, du er handlekraftig. Du tok valg. Du gikk videre. Du fullførte. Det er sjeldent og dyrebart. Hvert flisvalg, hvert fargevalg, hvert lille detalj bærer ditt fingeravtrykk. Dette badet er deg.',
  ...
  'Til dere begge: Dette badet kommer til å gi glede i mange, mange år. Hvert bad om morgenen. Hvert speil du ser deg selv i. Det er NITINAs blikk. Det er STIGs nettverk. Det er TEAMETS seier. Og denne Pisken er stolt — genuint, uforbeholdent stolt.',
  '🛁 ✨ GRATULERER, NINA OG STIG! ✨ 🛁',
  '🎂 Og LYKKE TIL MED 60-ÅRSDAGEN, NINA! 🎂',
];
  ...
  return createPortal(
    <div className="completion-overlay" onClick={onClose}>
      <div className="completion-inner" onClick={e => e.stopPropagation()}>
        ...
        <div className="completion-subtitle">12. JULI · NINA FYLLER 60 · DRØMMEBAD LEVERT</div>
